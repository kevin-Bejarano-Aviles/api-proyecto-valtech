...
function Menu() {
    ...
    const navLinkStyles = ({ isActive}) => {
        return{
          ...
          backgroundColor: isActive ? '#1EC5BB' : 'white',
          fill: isActive ? '#0BA4A0' : '#2E384D',
          borderLeft: isActive ? '#0BA4A0' : 'white'
        }
    }
  ...
  return (
   ...
   <div className='mt-[67px]'>
    <NavLink to ={'/inicio'} className="flex items-center w-[234px] h-[56px]" style={navLinkStyles} >
    <div className='ml-8'>
    ...
    <NavLink to ={'/orientados'} className="flex items-center w-[234px] h-[56px]" style={navLinkStyles} >
    <div className='ml-8'>
    ...
    <NavLink to ={'/eventos'} className="flex items-center w-[234px] h-[56px]" style={navLinkStyles}>
    <div className='ml-8'>
