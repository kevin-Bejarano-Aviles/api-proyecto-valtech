...
function Menu() {
  return (
        ...
        <div className='w-[234px] h-screen bg-white border-r border-bordergray'>
         ...
         <div><Link to ={'/'}><h3 className='text-base mt-[67px] flex flex-row ml-8 font-normal '> <img className='mr-2' src={IconHome} alt="" />Inicio</h3></Link></div>
         <div><Link to ={'/orientados'}><h3 className='text-base mt-8 flex flex-row ml-8 font-normal '> <img className='mr-2' src={IconOrientados} alt="" />Orientados</h3></Link></div>
