...
function TextInput ({ errorPost=null,error,label,touched, ...props })  {
  ...
  return (
      <div className='flex flex-col gap-1 tablet:grow tablet:max-w-[320px] mb-8'>
        ...
        <input
          className={`w-full tablet:max-w-[320px] p-2 h-10 rounded-lg border-2 ${(error || errorPost) && touched ? 'border-red-500' : ''} ${!error && touched ? 'bg-imgheader' :''} focus:outline-green`} 
