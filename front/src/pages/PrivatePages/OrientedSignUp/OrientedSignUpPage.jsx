...
function OrientedSignUpPage() {
	...
	dni:Yup.string().matches(/^[0-9]\d{10,50}$/, 'Sólo números entre 10 y 50 dígitos').oneOf([Yup.ref('user')],'Los dni no coinciden'),    
    ...
    user:Yup.string().matches(/^[0-9]\d{10,50}$/, 'Sólo números entre 10 y 50 dígitos').oneOf([Yup.ref('dni')],'Los dni no coinciden'),
